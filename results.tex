...
\begin{figure*}[t]
  ...
  \subfloat[$f11\ (D=3)$\label{fig:f11-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/Lv_f11_plot.tikz}}
  \subfloat[$f13\ (D=4)$\label{fig:f13-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/Lv_f13_plot.tikz}}
  \subfloat[$f14\ (D=5)$\label{fig:f14-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/Lv_f14_plot.tikz}}\\
  \subfloat{\includegraphics{plots/obj_label.tikz}}%
  \addtocounter{subfigure}{-1}%
  \subfloat[$f15\ (D=6)$\label{fig:f15-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/Lv_f15_plot.tikz}}
  \subfloat[$f16\ (D=8)$\label{fig:f16-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/Lv_f16_plot.tikz}}
  \subfloat[$f17\ (D=8)$\label{fig:f17-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/Lv_f17_plot.tikz}}
...
\begin{figure*}[h!]
  ...
  \subfloat{\includegraphics{plots/obj_label.tikz}}%
  \addtocounter{subfigure}{-1}%
  \subfloat[$Griewank_2\ (D=3)$\label{fig:gw23-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/GW_d3_e2_plot.tikz}}
  \subfloat[$Griewank_2\ (D=5)$\label{fig:gw25-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/GW_d5_e2_plot.tikz}}
  \subfloat[$Griewank_2\ (D=8)$\label{fig:gw28-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/GW_d8_e2_plot.tikz}}\\
  \subfloat{\includegraphics{plots/obj_label.tikz}}%
  \addtocounter{subfigure}{-1}%
  \subfloat[$Griewank_6\ (D=3)$\label{fig:gw63-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/GW_d3_e6_plot.tikz}}
  \subfloat[$Griewank_6\ (D=5)$\label{fig:gw65-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/GW_d5_e6_plot.tikz}}
  \subfloat[$Griewank_6\ (D=8)$\label{fig:gw68-conv}]{\includegraphics[width = 0.32\textwidth]{plots/mfits/GW_d8_e6_plot.tikz}}
  \caption{Mean convergence plots for $Griewank$ problem instance of dataset $B$, over 30 runs.} 
    \label{fig:set-b-conv}
\end{figure*}
...
\begin{figure*}[h!]
  \centering
  \quad \subfloat[\AlgName{} $(D=3)$\label{fig:sam-3d-mfits}]{\includegraphics[width = 0.31\textwidth]{plots/projections/GW_d3_e2_mfits_proj.tikz}}
  \subfloat[Co-kriging $(D=3)$\label{fig:sam-3d-cokrig}]{\includegraphics[width = 0.31\textwidth]{plots/projections/GW_d3_e2_cokrig_proj.tikz}}
  \subfloat[\motos{} $(D=3)$\label{fig:sam-3d-motos}]{\includegraphics[width = 0.31\textwidth]{plots/projections/GW_d3_e2_motos_proj.tikz}}\\
  \subfloat[\AlgName{} $(D=8)$\label{fig:sam-8d-mfits}]{\includegraphics[width = 0.31\textwidth]{plots/projections/GW_d8_e2_mfits_proj.tikz}}
  \subfloat[Co-kriging $(D=8)$\label{fig:sam-8d-cokrig}]{\includegraphics[width = 0.31\textwidth]{plots/projections/GW_d8_e2_cokrig_proj.tikz}}
  \subfloat[\motos{} $(D=8)$\label{fig:sam-8d-motos}]{\includegraphics[width = 0.31\textwidth]{plots/projections/GW_d8_e2_motos_proj.tikz}}
  \caption{Sammon mapping projection of samples onto the 2D plane for the Griewank function at $D=3$ and $D=8$. Low-fidelity samples are un-filled circles and high-fidelity samples are filled. Blue indicates higher quality solution and red indicates poorer quality.} 
    \label{fig:sammon}
\end{figure*}
