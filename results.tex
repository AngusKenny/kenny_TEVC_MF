...
\begin{figure*}[t]
  ...
  \caption{Mean convergence plots for problem instances $f11$, $f13$, $f14$, $f15$, $f16$ and $f17$ of dataset $A$, over 30 runs. Blue and red colours indicate \AlgName{} and the co-kriging base-line, respectively.} 
    \label{fig:set-a-conv}
\end{figure*}
...
\begin{figure*}[h!]
  ...
  \caption{Mean convergence plots for $Griewank$ problem instance of dataset $B$, over 30 runs. Blue and red colours indicate \AlgName{} and the co-kriging base-line, respectively.} 
    \label{fig:set-b-conv}
\end{figure*}
